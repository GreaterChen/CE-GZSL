...
class DATA_LOADER(object):
	...
	def read_aptos(self, opt):
		...
		self.allclasses = [0, 1, 2, 3, 4]
		self.seenclasses = [0, 2, 3, 4]
		self.unseenclasses = [1]
