...
parser.add_argument('--dataset', default='APTOS', help='FLO')
parser.add_argument('--dataroot', default='/home/chenlb/datasets/DR/APTOS/w224n808', help='path to dataset')
...
parser.add_argument('--nclass_all', type=int, default=5, help='number of all classes')
...
model_path = '/home/chenlb/compare_model/CE-GZSL/results/' + opt.dataset
